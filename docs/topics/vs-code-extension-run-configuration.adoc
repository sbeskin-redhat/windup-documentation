...
* `{LC_PSN}-cli` executable installed. You can download the `{LC_PSN}-cli` executable from link:https://developers.redhat.com/products/mta/download[{ProductShortName} download].
